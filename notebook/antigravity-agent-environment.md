...
| MCP 서버 | 용도 |
|---|---|
| `cloudrun` | Google Cloud Run 연동 (`npx @google-cloud/cloud-run-mcp`) |
| `notebooks` | Google Cloud DataCloud — 노트북 프록시 |
| `visualization` | Google Cloud DataCloud — 시각화 프록시 |
| `vibe-diagnosis` | 로컬 자가진단 MCP 서버 (별도 워크스페이스) |
